...
E_D("replace into `phome_enewsuseradd` values('2','0','','','','0');");
E_D("replace into `phome_enewsuseradd` values('3','0','','','','0');");
E_D("replace into `phome_enewsuseradd` values('4','0','','','','0');");
E_D("replace into `phome_enewsuseradd` values('5','0','','','','0');");
