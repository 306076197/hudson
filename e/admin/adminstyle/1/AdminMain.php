...
<TITLE>信远科技网站管理系统 － 最安全、最稳定的开源CMS系统</TITLE>
...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR> 
            <TD width="180"><div align="center"><a href="main.php" target="main" title="广州信远信息科技有限公司后台管理系统"><img src="adminstyle/1/images/logo.gif" border="0"></a></div></TD>
		<TD height="60"> 
...
<div align="center"><font color="#FFFFFF"><strong>用户</strong></font></div></td>
                    ...
                    <TD id="dotoolmenu"> 
                     ...
                     <!-- 二次开发，二次修改开始 -->
					<TD width=0 id="doshopmenu"> 
					<!-- 此处去掉了一些内容，主要是删除主菜单上的商城图标 -->
                    </TD>
                    <!-- 二次开发，二次修改结束 -->
                    <TD id="doothermenu">
                      </TD>
...
<div align="center"><font color="#FFFFFF"><strong>常用</strong></font></div></td>
                    ...
                    <TD width="301"><div align="right"><font color="#ffffff">用户：<a href="user/EditPassword.php" target="main"><font color="#ffffff"><b><?=$loginin?></b></font></a>&nbsp;&nbsp;&nbsp;[<a href="#ecms" onclick="if(confirm('确认要退出?')){JumpToMain('ecmsadmin.php?enews=exit');}"><font color="#ffffff">退出</font></a>]&nbsp;&nbsp;</font></div></TD>
                  </TR>
                </TBODY>
              </TABLE>
              ...
              <TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle> 
					...
					?>
					<TD width="60" class="flyoutLink" onclick="JumpToMain('info/InfoMain.php');" onmouseover="over(this)" onmouseout="out(this)">数据统计</TD>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('infotop.php');" onmouseover="over(this)" onmouseout="out(this)">排行统计</TD>
