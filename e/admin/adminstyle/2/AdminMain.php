...
<td height="60">
  ...
  <TABLE width="100%" height="60" border=0 cellpadding="0" cellSpacing=0 background="adminstyle/2/images/topbg.gif">
    <TBODY>
      <TR> 
        <TD width="180"><div align="center"><a href="main.php" target="main" title="信远科技网站管理系统"><img src="adminstyle/2/images/logo.gif" border="0"></a></div></TD>
		<TD height=60> 
			<TABLE width=480 height="60" border=0 cellpadding="0" cellSpacing=0>
                <TBODY>
                  <TR align=middle> 
                    <TD width=80 onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#8CBDEF';tododisplay('ecmsinfomenu');" onclick="switchSysBarInfo();JumpToLeftMenu('ListEnews.php');" style="CURSOR: hand"> 
                    ...
                    <TD width="351"><div align="right"><font color="#ffffff">用户：<a href="user/EditPassword.php" target="main"><font color="#ffffff"><b><?=$loginin?></b></font></a>&nbsp;&nbsp;&nbsp;[<a href="#ecms" onclick="if(confirm('确认要退出?')){JumpToMain('ecmsadmin.php?enews=exit');}"><font color="#ffffff">退出</font></a>]&nbsp;&nbsp;</font></div></TD>
                  </TR>
                </TBODY>
              </TABLE>
