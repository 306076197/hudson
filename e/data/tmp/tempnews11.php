...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://www.dongpeng.net/css/style.css" />
...
?>
    ...
    <!-- 头部结束   -->
     <div class=" wrap">
   <div class="home">当前位置：当前位置：<?=$grurl?></div>
...
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select morepic from phome_ecms_photo_data_1 where id='.$navinfor[id],2,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
      ...
      <div class="slidenumbg">
         ...
         ?>
                        ...
                        <script src="http://www.hudsonhome.cn/skin/default/js/jquery_002.js" type="text/javascript"></script>

                        <script src="http://www.hudsonhome.cn/skin/default/js/slider.js" type="text/javascript"></script>
...
?>
  ...
  友情链接：
  	<a href="http://www.sun-cad.com" target="_blank">散热器</a>
                  ...
                  <a href="http://tianjin.haogongzhang.com" target="_blank">天津装修队</a>
