...
<title>哈德逊瓷砖官网|全抛釉瓷砖|微晶石瓷砖|浴室砖瓷砖|背景墙|仿古砖|木纹砖|哈德逊瓷砖-中国领先的品牌瓷砖生产经销商 - www.hudsonhome.cn</title>
...
?>
							     <?php 
								     if($bqr[classid]==15){
								     	$bqr[classpath] = 'cptyg/shtyg/2014-02-25/1.html';
								     }
								   ?>
							     <span><a href="http://www.hudsonhome.cn/<?=$bqr[classpath]?>"><?=$bqr[classname]?></a></span>
							    <?php
...
<!-- 头部结束   -->
     <div class=" wrap">
   <div class="home">当前位置：<a href="http://www.hudsonhome.cn/index.html">首页</a>&nbsp;>&nbsp;<a href="http://www.hudsonhome.cn/cptyg/">产品体验馆</a></div>
    ...
    <div class="main">
        ...
        <div class="shang"><a href="http://www.hudsonhome.cn/cptyg/shtyg/2014-02-25/1.html"><img src="http://www.hudsonhome.cn/skin/default/images/b_left.gif" /></a></div>
          <div class="xia"><a href="#"><img src="http://www.hudsonhome.cn/skin/default/images/b_right.gif" /></a></div>
            <div class="tixian_tt">
                <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select title from phome_ecms_photo where classid=15 order by id desc limit 4',2,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
                 <?php 
                   ...
                   $dascss = $bqno==1?'hover':'';
                 ?>
			     <span class="<?=$dascss?>" onclick="setTab('showbox',<?=$bqno?>,4)" id="showbox<?=$bqno?>" style="<?=$sdcss?>"><a href="javascript:"><?=$bqr[title]?></a><img src="http://www.hudsonhome.cn/skin/default/images/tx<?=$bqno?>1.jpg" /></span>
			    <?php
}
}
?>
        ...
        <div class="txwrap2">
            <div class="tixian2">
                <div class="tixianbg">
                    ...
                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select id from phome_ecms_photo where classid=15 order by id desc limit 4',2,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
  ...
  友情链接：
  	<a href="http://www.sun-cad.com" target="_blank">散热器</a>
                  <a href="http://www.zjhenghui.cn" target="_blank">头盔镜片</a>
                  ...
                  <a href="http://beihai.to8to.com" target="_blank">北海装修网</a>
                  ...
                  <a href="http://bj.fenlei.3ghuashang.com/zhuangxiu/" target="_blank">北京装修公司</a>
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Faed9e7d575a1cc8a944631fa5314681e' type='text/javascript'%3E%3C/script%3E"));
   ...
   <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_5915010'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s19.cnzz.com/stat.php%3Fid%3D5915010%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script><br/>
    ...
    <script type="text/javascript" src="http://www.hudsonhome.cn/skin/default/js/prolist2.js"></script>
