...
<!-- 头部结束   -->
     <div class=" wrap">
   <div class="home">当前位置：<a href="http://www.hudson.com/index.html">首页</a>&nbsp;>&nbsp;<a href="http://www.hudson.com/cptyg/">产品体验馆</a></div>
    ...
    <div class="main">
        ...
        <div class="shang"><a href="http://www.hudson.com/cptyg/shtyg/2014-02-25/1.html"><img src="http://www.hudson.com/skin/default/images/b_left.gif" /></a></div>
          <div class="xia"><a href="#"><img src="http://www.hudson.com/skin/default/images/b_right.gif" /></a></div>
            <div class="tixian_tt">
                <?php
$bqno=0;
...
?>
                 <?php 
                   ...
                   $dascss = $bqno==1?'hover':'';
                 ?>
			     <span class="<?=$dascss?>" onclick="setTab('showbox',<?=$bqno?>,4)" id="showbox<?=$bqno?>" style="<?=$sdcss?>"><a href="javascript:"><?=$bqr[title]?></a><img src="http://www.hudson.com/skin/default/images/tx<?=$bqno?>1.jpg" /></span>
			    <?php
}
}
?>
