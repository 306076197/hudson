...
<title>人力资源 哈德逊瓷砖官网|全抛釉瓷砖|微晶石瓷砖|浴室砖瓷砖|背景墙|仿古砖|木纹砖|哈德逊瓷砖-中国领先的品牌瓷砖生产经销商 - www.hudsonhome.cn</title>
...
<!--[if lte IE 6]>
<SCRIPT src="http://www.hudsonhome.cn/skin/default/js/iepng.js" type="text/javascript"></SCRIPT>
<script> 
...
<!-- 头部结束   -->
  <div class=" wrap">
   <div class="home">当前位置：<a href="http://www.hudsonhome.cn/index.html">首页</a>&nbsp;>&nbsp;<a href="http://www.hudsonhome.cn/rlzy/">人力资源</a></div>
                ...
                <div class="hrmain">
                    <div class="hrban">
                        <div class="hrlist">
                            <div class="hrshow">
                                <ul class="hrshlist">
                                    <li>一个讲诚信的人，才能够努力地去工作；</li>
                                    <li>一个有激情的人，才能够主动地去工作；</li>
                                    <li>一个善沟通的人，才能够和谐地去工作；</li>
                                    <li>一个重责任的人，才能够踏实地去工作；</li>
                                    <li>一个精业务的人，才能够积极地去工作；</li>
                                    <li>一个大作为的人，才能够高效地去工作。</li>
                                </ul>
                                <div class="hrbtn">
                                    <a href="http://www.hudsonhome.cn/rlzy/zwlb/">
                                       <img src="http://www.hudsonhome.cn/skin/default/images/hr_pic1.jpg" width="110" height="29" /></a></div>
                            </div>
                        </div>
                        <img src="http://www.hudsonhome.cn/skin/default/images/hrban.jpg" width="917" height="233" />
                    </div>
                    <!--hrban over-->
                    <div class="hrleft">
                        <ul class="hrcase">
                             ...
                             <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select classid,classname,classpath,classimg,intro from phome_enewsclass where bclassid=6 order by classid asc',2,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
							    <?php 
							      if($bqr[classid]==16){
							      	...
							      	$bqr[classpath] = 'rlzy/xcfl/2014-03-02/47.html';
							      }
							    ?>
							     <li>
                                        <div class="hrpic">
                                            <a href="http://www.hudsonhome.cn/<?=$bqr[classpath]?>">
                                                <img src="<?=$bqr[classimg]?>" width="205" height="143" /></a></div>
                                        <div class="hrword">
                                            <h2><a href="http://www.hudsonhome.cn/<?=$bqr[classpath]?>"><?=$bqr[classname]?></a></h2>
                                            <p><?=$bqr[intro]?></p>
                                         <span class="more"><a href="http://www.hudsonhome.cn/<?=$bqr[classpath]?>">详细>></a></span>
                                        </div>
                                 </li>
							 <?php
}
...
?>
                    ...
                    <div class="hrright">
                        <div class="hrtit">
                            <h2>
                                <span><a href="/hr/figure.aspx">更多>></a></span>我在哈德逊</h2>
                        </div>
                        <div class="hrbox">
                            
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select title,titleurl,titlepic,smalltext from phome_ecms_news where classid=21 order by id desc limit 4',2,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
                                    <div class="hrpeo">
                                        <img src="<?=$bqr[titlepic]?>" width="90" height="120" />
                                    </div>
                                    <div class="hrintr">
                                      <?=$bqr[title]?>，<?=esub($bqr[smalltext],68)?><span><a href="http://www.hudsonhome.cn/rlzy/wzhdx/" style="color:#c4261d;">
                                                                                                        详细>></a></span>
                                    </div>
                                    <div class="cls" style="padding-top: 10px;"></div>
                           <?php
}
}
?>
