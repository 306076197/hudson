...
<!-- 头部结束   -->
  <div class=" wrap">
   <div class="home">当前位置：<a href="http://www.hudson.com/index.html">首页</a>&nbsp;>&nbsp;<a href="http://www.hudson.com/rlzy/">人力资源</a></div>
                    ...
                    <div class="hrban">
                        <div class="hrlist">
                            <div class="hrshow">
                                ...
                                <div class="hrbtn">
                                    <a href="http://www.hudson.com/rlzy/zwlb/">
                                       <img src="http://www.hudson.com/skin/default/images/hr_pic1.jpg" width="110" height="29" /></a></div>
                            </div>
                        </div>
                        <img src="http://www.hudson.com/skin/default/images/hrban.jpg" width="917" height="233" />
                    </div>
                    <!--hrban over-->
                    <div class="hrleft">
                        <ul class="hrcase">
...
?>
							    ...
							    ?>
							     <li>
                                        ...
                                        <div class="hrword">
                                            <h2><a href="http://www.hudson.com/<?=$bqr[classpath]?>"><?=$bqr[classname]?></a></h2>
                                            <p><?=$bqr[intro]?></p>
                                         <span class="more"><a href="http://www.hudson.com/<?=$bqr[classpath]?>">详细>></a></span>
                                        </div>
                                 </li>
							 <?php
}
...
?>
                                    ...
                                    <div class="hrintr">
                                      <?=$bqr[title]?>，<?=esub($bqr[smalltext],68)?><span><a href="http://www.hudson.com/rlzy/wzhdx/" style="color:#c4261d;">
                                                                                                        详细>></a></span>
                                    </div>
