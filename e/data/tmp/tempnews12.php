   ...
   <div class="home">当前位置：<?=$grurl?></div>
    ...
    <div class="main">
        ...
        <div class="shang"><a href="http://www.hudsonhome.cn/cptyg/shtyg/2014-02-25/1.html"><img src="http://www.hudsonhome.cn/skin/default/images/b_left.gif" /></a></div>
          <div class="xia"><a href="http://www.hudsonhome.cn/qt/2014-04-04/181.html"><img src="http://www.hudsonhome.cn/skin/default/images/b_right.gif" /></a></div>
            <div class="tixian_tt">
                <?php
$bqno=0;
...
?>
                 <?php 
                   ...
                   $dascss = $bqno==1?'hover':'';
                 ?>
			     <span class="<?=$dascss?>" onclick="setTab('showbox',<?=$bqno?>,4)" id="showbox<?=$bqno?>" style="<?=$sdcss?>"><a href="javascript:"><?=$bqr[title]?></a><img src="http://www.hudsonhome.cn/skin/default/images/tx<?=$bqno?>.jpg" /></span>
			    <?php
}
}
?>
