   ...
   <div class="home">当前位置：[!--newsnav--]&gt;[!--pagetitle--]</div>
     ...
     <div class="cls"></div>
  	...
  	<div class="mleft">
         			...
         			<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select classname from phome_enewsclass where classid=4',2,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
            	...
            	<div class="mright">
                <div class="aboutban">
                        <img src="[!--news.url--]skin/default/images/ban_serpro.jpg" width="711" height="200" /></div>
                <ul class="prolist">
                      [!--empirenews.listtemp--]
					    <!--list.var1-->
					  [!--empirenews.listtemp--]
